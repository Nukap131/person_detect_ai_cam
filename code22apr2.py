...
print("FABLAB PERSON TÆLLER V2.5 (VERTICAL - LEFT TO RIGHT = IND, STABLE)")
...
# Kun start-side hvis tydeligt væk fra linjen
start_margin = 25

# Kræv reel bevægelse
min_cross_distance = 35
...
try:
    while True:
        ...
        for tid, track in tracks.items():
            ...
            # Sæt start-side kun når personen er tydeligt væk fra linjen
            ...
            if (
                ...
                and x > (right_line + start_margin)
                and (x - track["start_x"]) >= min_cross_distance
            ):
                ...
                print("IND | Track", tid, "| start_x:", track["start_x"], "| x:", x, "| Inside:", current_inside)
